defmodule EvalSandboxRestrictedTest do
  ...
  test "allowed works" do
    ...
    assert(
      EvalSandbox.RestrictedEvaluator.evaluate_restricted(allowed, SandboxAllowOnlyStringReverse) ==
        "cba"
    )
  end
  ...
  test "disallowed raises exception" do
    assert_raise UndefinedFunctionError, fn ->
      ...
      EvalSandbox.RestrictedEvaluator.evaluate_restricted(
        disallowed,
        SandboxAllowOnlyStringReverse
      )
    end
  end
